...
export default function ContinueLearningCard() {
  ...
  return (
    <div className="flex flex-col gap-5 rounded-2xl border border-ink-200/60 bg-white p-6 shadow-card">
      <div className="flex items-center justify-between gap-3">
        <h2 className="text-lg font-bold text-ink-900">Continuar aprendendo</h2>
        <button
          type="button"
      ...
      <div className="flex flex-col gap-5 sm:flex-row">
        ...
        */}
        <div className="relative flex h-36 w-full shrink-0 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-navy-900 via-navy-800 to-brand-blue-700 sm:h-auto sm:w-40">
          ...
          <ShieldCheck className="relative h-14 w-14 text-brand-cyan-400" strokeWidth={1.5} aria-hidden="true" />
        </div>
        ...
        <div className="flex flex-1 flex-col justify-between gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="h-2 w-full overflow-hidden rounded-full bg-ink-100">
              <div className="h-full rounded-full bg-brand-blue-600" style={{ width: `${data.progressPercent}%` }} />
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-col gap-1 text-xs text-ink-500">
              <span className="flex items-center gap-1.5">
                <BookOpenCheck className="h-3.5 w-3.5" strokeWidth={2} aria-hidden="true" />
